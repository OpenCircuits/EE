...
export class PositionPopupModule extends SelectionPopupModule {
    ...
    public pull(): void {
        ...
        const components = selections.filter(o => o instanceof EEComponent).map(o => o as EEComponent);
    ...
    public push(): void {
        let components = MainDesignerController.GetSelections().filter(o => o instanceof EEComponent).map(o => o as EEComponent);
